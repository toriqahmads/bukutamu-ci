                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="<?php echo base_url('bukutamu/update/'.$bukutamu->kode); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group <?php echo form_error('jam_kunjung') ? 'has-error' : '' ?>">
                                            ...
                                            <input name="jam_kunjung" class="form-control <?php echo form_error('jam_kunjung') ? 'inputError' : '' ?>" id="jam_kunjung" placeholder="Jam Kunjung" value="<?php echo $bukutamu->jam_kunjung; ?>"> 
                                            <div class="invalid-feedback">
